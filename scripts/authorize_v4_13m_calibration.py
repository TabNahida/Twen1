#!/usr/bin/env python3
"""Plan or publish the pre-training admission for v4 13M calibration.
...
13M calibration profile in the Dashboard allow-list.
...
SCHEMA_VERSION = 1
PROFILE_ID = "base-dense-v4-13m-low-lr-calibration"
ADMISSION_KIND = "twen_v4_13m_calibration_admission"
BUNDLE_KIND = "twen_v4_13m_calibration_admission_bundle"
COMPLETE_KIND = "twen_v4_13m_calibration_admission_complete"
ADMISSION_NAME = "admission.json"
DASHBOARD_NAME = "dashboard.json"
MANIFEST_NAME = "MANIFEST.json"
COMPLETE_NAME = "COMPLETE"
AUTHORIZED_LABEL = "Base Dense v4 13M (license accepted; awaiting explicit START)"
ROOT = Path(__file__).resolve().parents[1]
EXPECTED_CLOSURE_MANIFEST_SHA256 = (
    "b496a8f90fc23e70ebc101c0d54a6e4cc10158f14da57b47dfa3b03a7dd01885"
)
EXPECTED_CONFIG_PATH = "configs/base/dense-v4-13m-low-lr-calibration.yaml"
EXPECTED_CONFIG_SHA256 = "15ce9dbf68643b6abbcbc687a698f2994e2200587c442974903b07613a43109d"
...
EXPECTED_RUN_DIR = "runs/base-dense-v4-13m-low-lr-calibration"
...
def _load_publisher() -> tuple[ModuleType, str]:
    ...
    spec = importlib.util.spec_from_file_location(
        "_twen_v4_release_publisher_for_calibration_admission",
        path,
    )
...
def _authenticate_inputs(args: argparse.Namespace) -> dict[str, Any]:
    ...
    try:
        ...
        governed = publisher._authenticate_governed_closure_gates(closure)
...
def _build_plan(
    ...
    *,
    ...
    return {
        "schema_version": SCHEMA_VERSION,
        "kind": "twen_v4_13m_calibration_admission_plan",
...
def verify_admission(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if any(path.is_symlink() for path in output.rglob("*")):
        raise CalibrationAdmissionError("calibration admission bundle contains a symlink")
